...
- (void)layoutSubviews {
    ...
    if (_buttonTitleStr) { // ---- 没有定位城市时，定位按钮状态

        CGFloat buttonW = [_buttonTitleStr sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:20.f],NSFontAttributeName,nil]].width;
