...
-(UIImage *)drawImageAtImageContextfid:(NSString *)fid mobile:(NSString *)mobile realname:(NSString *)realname{
    ...
    /// 绘制二维码 2480 3508
    UIImage *CodeImage = [ManagerEngine createNonInterpolatedUIImageFormCIImage:[ManagerEngine outputImageStr:[NSString stringWithFormat:@"%@static/?fid=%@&sid=%@",HQJBBonusDomainName,fid,mobile]] withSize:203];
...
- (void)requstFid:(void(^)(NSString *fid,NSString *mobile,NSString *realname))complete {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@%@",HQJBBonusDomainName,HQJBMerchantInterface,HQJBGetMerchantBasicInfoInterface];
