...
- (void)settitleImage:(NSString *)imageStr name:(NSString *)name price:(NSString *)price count:(NSString *)count {
    [self.titleImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",ImageTest_URL,imageStr]] placeholderImage:[UIImage imageNamed:@"default_image"]];
