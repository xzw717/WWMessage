...
/** 初始化配置方法 自定义提示标题，无内容  可自定义按钮title  第一个默认按钮只可自已定义文字，第二个可以自行定制，可传字典类型 eg：@{AlertViewTitleColor：红色} 回调是两个按钮点击后的回调   */
...
/** 初始化配置方法 自定义内容，无标题  可自定义按钮title  第一个默认按钮只可自已定义文字，第二个可以自行定制，可传字典类型 eg：@{AlertViewTitleColor：红色} 回调是两个按钮点击后的回调   */
...
/** 初始化配置方法 标题内容可自定义  可自定义按钮title  第一个默认按钮只可自已定义文字，第二个可以自行定制，可传字典类型 eg：@{AlertViewTitleColor：红色} 回调是两个按钮点击后的回调   */
+ (void)alertViewInitWithTitle:(nullable NSString *)title
