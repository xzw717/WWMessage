...
- (void)getoPay{
    if (!self.payView.selectBtn.selected) {
        ...
        [PayEngine payActionOutTradeNOStr:self.model.orderid andSubjectStr:self.payTypeArray[self.model.proid.integerValue] andNameStr:self.payTypeArray[self.model.proid.integerValue] andTotalFeeSt:@"0.01"];
